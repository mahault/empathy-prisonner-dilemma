...
def play(agent_kwargs, strat, T=100, seed=0, return_agent=False):
    ...
    return dict(
        ...
        agent=(ag if return_agent else None),
    )
...
def main():
    print("=" * 74)
    print("A. AGENTS vs FIXED-STRATEGY PARTNERS  (100 rounds x 10 seeds, standard PD)")
    print("=" * 74)
